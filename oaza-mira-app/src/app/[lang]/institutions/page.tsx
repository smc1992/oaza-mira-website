    ...
    <div className="page-wrapper relative overflow-hidden bg-gradient-to-b from-[#FDFCF9] via-[#FCFAF2] to-[#FDFCF9] min-h-screen">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex flex-col items-center justify-center text-center px-4 min-h-[90vh] -mb-px">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/extracted/institutions_hero.jpg" 
        ...
        <AnimatedSection delay={0.1}>
          <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#E9C36B]/40 bg-[#E09D00]/25 text-[#E9C36B] text-sm font-bold tracking-widest uppercase mb-10 shadow-lg backdrop-blur-md">
              <Landmark size={16} className="text-[#E9C36B]" strokeWidth={2.5} />
              <span data-dict-key="institutions.hero.badge">{dict["institutions.hero.badge"]}</span>
            </div>
            ...
            <div className="mt-14 flex flex-col sm:flex-row items-center justify-center gap-6 w-full px-4 relative z-20">
              ...
              <MagneticPull strength={15}>
                <a href="#how" className="inline-flex items-center justify-center gap-3 px-10 py-5 rounded-full bg-white/25 backdrop-blur-md !text-white border border-white/25 shadow-lg font-bold text-lg hover:bg-white hover:!text-[#1a2208] transition-all duration-300 transform-gpu translate-z-0">
                  <span data-dict-key="institutions.hero.cta2">{dict["institutions.hero.cta2"]}</span>
                </a>
              </MagneticPull>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection delay={0.2}>
            <div className="text-center max-w-3xl mx-auto">
              <span data-dict-key="institutions.steps.eyebrow" className="text-[#50641B] font-bold tracking-widest uppercase text-sm mb-4 block">
                {dict["institutions.steps.eyebrow"]}
              </span>
              <h2 className="text-4xl md:text-5xl font-extrabold text-[#333] tracking-tight leading-[1.1] mb-6">
                <span data-dict-key="institutions.steps.title1">{dict["institutions.steps.title1"]}</span>
                <span data-dict-key="institutions.steps.title2" className="font-serif italic font-normal text-[#E09D00]">{dict["institutions.steps.title2"]}</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mt-16">
              {[1, 2, 3, 4].map((stepNum) => (
                <div key={stepNum} className="flex flex-col p-8 rounded-3xl bg-white border border-[#E9C36B]/15 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
                  ...
                  <h3 data-dict-key={`institutions.steps.s${stepNum}.title`} className="text-xl font-extrabold text-[#333] mb-3">
                    {dict[`institutions.steps.s${stepNum}.title`]}
                  </h3>
                  <p data-dict-key={`institutions.steps.s${stepNum}.desc`} className="text-[#7A7366] text-sm leading-relaxed font-medium">
                    {dict[`institutions.steps.s${stepNum}.desc`]}
                  </p>
                </div>
              ))}
            </div>
          ...
          <AnimatedSection delay={0.2}>
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-[45%] aspect-[4/3] lg:aspect-[1.2] relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-[#E9C36B]/25">
                <Image
                  src="/extracted/institutions_sec1.jpg"
                  alt="Care for graves of public importance"
                  fill
                ...
                <span data-dict-key="institutions.split1.media" className="absolute bottom-6 left-6 z-20 px-4 py-2 bg-black/30 backdrop-blur-md text-white text-xs font-bold uppercase tracking-widest rounded-lg">
                  {dict["institutions.split1.media"]}
                </span>
              </div>

              {/* Content Right */}
              <div className="w-full lg:w-[55%] flex flex-col justify-center">
                <span data-dict-key="institutions.split1.eyebrow" className="text-[#50641B] font-bold tracking-widest uppercase text-sm mb-4">
                  {dict["institutions.split1.eyebrow"]}
                </span>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#333] tracking-tight leading-[1.1] mb-6">
                  <span data-dict-key="institutions.split1.title1">{dict["institutions.split1.title1"]}</span>
                  <span data-dict-key="institutions.split1.title2" className="font-serif italic font-normal text-[#E09D00]">{dict["institutions.split1.title2"]}</span>
                </h2>
                <p data-dict-key="institutions.split1.desc" className="text-lg text-[#7A7366] leading-relaxed font-medium mb-8">
                  {dict["institutions.split1.desc"]}
                </p>
                <div>
                  <MagneticPull strength={15}>
          ...
          <AnimatedSection delay={0.2}>
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-[55%] flex flex-col justify-center order-last lg:order-first">
                <span data-dict-key="institutions.split2.eyebrow" className="text-[#50641B] font-bold tracking-widest uppercase text-sm mb-4">
                  {dict["institutions.split2.eyebrow"]}
                </span>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#333] tracking-tight leading-[1.1] mb-6">
                  <span data-dict-key="institutions.split2.title1">{dict["institutions.split2.title1"]}</span>
                  <span data-dict-key="institutions.split2.title2" className="font-serif italic font-normal text-[#E09D00]">{dict["institutions.split2.title2"]}</span>
                </h2>
                <p data-dict-key="institutions.split2.desc" className="text-lg text-[#7A7366] leading-relaxed font-medium mb-8">
                  {dict["institutions.split2.desc"]}
                </p>
                <div>
                  <MagneticPull strength={15}>
                    <Link href={`/${lang}/contact`} className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-[#E09D00] to-[#E9C36B] text-[#1a2308] hover:!text-white font-extrabold text-base hover:scale-105 hover:shadow-[0_15px_30px_rgba(224,157,0,0.3)] transition-all duration-300 shadow-lg border border-white/20">
              ...
              <div className="w-full lg:w-[45%] aspect-[4/3] lg:aspect-[1.2] relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-[#E9C36B]/25">
                ...
                <span data-dict-key="institutions.split2.media" className="absolute bottom-6 left-6 z-20 px-4 py-2 bg-black/30 backdrop-blur-md text-white text-xs font-bold uppercase tracking-widest rounded-lg">
                  {dict["institutions.split2.media"]}
                </span>
              </div>
            </div>
          </AnimatedSection>
      ...
      <section className="pt-24 pb-32 relative overflow-hidden px-4 z-10 bg-[#FDFCF9]">
        <AnimatedSection delay={0.3}>
          <div className="max-w-7xl mx-auto">
            <div className="relative rounded-[3rem] lg:rounded-[4rem] p-12 lg:p-24 overflow-hidden shadow-2xl shadow-[#50641B]/30 text-center group flex flex-col justify-center items-center min-h-[450px]">
              ...
              <div className="absolute inset-0 z-0">
                <img 
                  src="/extracted/institutions_cta_bg.jpg" 
              ...
              <div className="w-16 h-16 rounded-full bg-white/15 backdrop-blur-md flex items-center justify-center mb-6 relative z-10 border border-white/10 shadow-lg">
                <Image 
                  src="/extracted/institutions_logo.png" 
                  alt="Oaza Mira Logo" 
                  width={40} 
                  height={40} 
