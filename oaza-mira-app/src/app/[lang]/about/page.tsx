        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection delay={0.1}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* Feature Cards with Premium Glassmorphism (8% opacity, XL blur) */}
              <div className="bg-white/8 backdrop-blur-xl rounded-3xl p-8 border border-white/12 h-full transform transition-all hover:scale-105 hover:bg-white/15 duration-500 shadow-2xl group transform-gpu translate-z-0">
                <div className="bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center text-[#E9C36B] mb-8 border border-white/12 group-hover:scale-110 transition-transform duration-500 shadow-lg">
                  <Link2 size={32} />
                </div>
